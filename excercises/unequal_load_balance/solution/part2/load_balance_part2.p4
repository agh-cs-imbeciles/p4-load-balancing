...
control MyIngress(inout headers hdr,
    ...
    action set_mp_select(
         ...
         * to determine meta.mp_select. Only switch S1 has specified weight and max_factor for granularity
         * in load balancing, other ones have weight equal to 0, remember about updating switch configurations.
         */
