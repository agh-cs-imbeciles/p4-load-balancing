...
In this exercise, you will implement a form of load balancing based on a simple
versions of Equal-Cost and Unequal-Cost Multipath Forwarding. The switch you
